...
export function ChatMessage({ role, content, type, mediaUrl }: ChatMessageProps) {
  ...
  return (
    ...
    >
      ...
      <div className={`flex max-w-[80%] flex-col gap-2 rounded-xl px-4 py-2 border transition-all ${
        isUser 
